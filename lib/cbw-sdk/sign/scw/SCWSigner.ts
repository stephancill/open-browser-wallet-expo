...
import { Method } from "@/lib/cbw-sdk/core/provider/method";
...
export class SCWSigner implements Signer {
  ...
  private async decryptResponseMessage<T>(
    ...
    if ("plaintext" in content) {
      return JSON.parse(content.plaintext as string);
    }
