...
import { SignerType } from "@/lib/cbw-sdk/core/message";
import { determineMethodCategory } from "@/lib/cbw-sdk/core/provider/method";
  ...
  implements ProviderInterface
{
  ...
  constructor({
    ...
    this.communicator = new Communicator(keysUrl, preference.callbackUrl);
    this.chain = {
