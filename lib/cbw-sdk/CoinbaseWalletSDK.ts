...
import { getFavicon } from "@/lib/cbw-sdk/core/type/util";
import { getCoinbaseInjectedProvider } from "@/lib/cbw-sdk/util/provider";
...
export class CoinbaseWalletSDK {
  ...
  public makeWeb3Provider(preference: Preference): ProviderInterface {
    const params = { metadata: this.metadata, preference };
    return (
      getCoinbaseInjectedProvider(params) ?? new CoinbaseWalletProvider(params)
    );
  }
